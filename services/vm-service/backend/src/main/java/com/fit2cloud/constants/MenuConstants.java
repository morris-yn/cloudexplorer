...
//            )
            ...
            .menu(new Menu.Builder()
                    ...
                    .title("默认配置")
                    .path("/default_config")
                    .icon("icon_setting_filled")
                    .order(6)
                    .componentPath("/src/views/default_config/index.vue")
                    .redirect("/default_config/list")
                    .requiredPermission(new MenuPermission.Builder()
                            .role(RoleConstants.ROLE.ADMIN)
                            .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                    )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            .name("default_config_list")
                            .title("列表")
                            .path("/list")
                            .saveRecent(true)
                            .componentPath("/src/views/default_config/list.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                            )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            .name("default_config_server_detail")
                            .title("详情")
                            .path("/detail/:id")
                            .componentPath("/src/views/default_config/detail.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.READ)
                            )
                    ...
                    .childOperationRoute(
                            new Menu.Builder()
                                    .name("default_config_add_disk")
                                    .title("添加磁盘")
                                    .path("/add_disk/:id")
                                    .componentPath("/src/views/default_config/AddDisk.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_DISK, OPERATE.CREATE)
                                    )
                    ...
                    .childOperationRoute(
                            new Menu.Builder()
                                    .name("default_config_change_config")
                                    .title("配置变更")
                                    .path("/change_config/:id")
                                    .componentPath("/src/views/default_config/ChangeConfig.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_SERVER, OPERATE.RESIZE)
                                    )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            ...
                            .quickAccessName("创建云主机")
                            .quickAccessIcon("icon_ecs_outlined")
                            .componentPath("/src/views/default_config/create/catalog.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.CREATE)
                            )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            .name("default_config_server_create")
                            .title("创建")
                            .path("/create/:accountId")
                            .componentPath("/src/views/default_config/create/index.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.CREATE)
                            )
                    ...
                    .order(6)
                    .componentPath("/src/views/live_online/index.vue")
                    .redirect("/live_online/list")
                    .requiredPermission(new MenuPermission.Builder()
                            .role(RoleConstants.ROLE.ADMIN)
                            .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                    )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            .name("live_online_list")
                            .title("列表")
                            .path("/list")
                            .saveRecent(true)
                            .componentPath("/src/views/live_online/list.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                            )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            ...
                            .title("详情")
                            .path("/detail/:id")
                            .componentPath("/src/views/live_online/detail.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.READ)
                            )
                    ...
                    .childOperationRoute(
                            new Menu.Builder()
                                    .name("live_online_disk")
                                    .title("添加磁盘")
                                    .path("/add_disk/:id")
                                    .componentPath("/src/views/live_online/AddDisk.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_DISK, OPERATE.CREATE)
                                    )
                    ...
                    .childOperationRoute(
                            new Menu.Builder()
                                    .name("live_online_change")
                                    .title("配置变更")
                                    .path("/change_config/:id")
                                    .componentPath("/src/views/live_online/ChangeConfig.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.CLOUD_SERVER, OPERATE.RESIZE)
                                    )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            ...
                            .quickAccessName("创建云主机")
                            .quickAccessIcon("icon_ecs_outlined")
                            .componentPath("/src/views/live_online/create/catalog.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.CREATE)
                            )
                    ...
                    .childOperationRoute(new Menu.Builder()
                            .name("live_online_create")
                            .title("创建")
                            .path("/create/:accountId")
                            .componentPath("/src/views/live_online/create/index.vue")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.CLOUD_SERVER, OPERATE.CREATE)
                            )
                            ...
                            .title("拉流用户列表")
                            .path("/pull_online")
                            .icon("icon_yes_outlined")
                            .order(6)
                            .componentPath("/src/views/pull_online/index.vue")
                            .redirect("/pull_online/list")
                            .requiredPermission(new MenuPermission.Builder()
                                    .role(RoleConstants.ROLE.ADMIN)
                                    .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                            )
                            ...
                            .childOperationRoute(new Menu.Builder()
                                    .name("pull_online_list")
                                    .title("列表")
                                    .path("/list")
                                    .saveRecent(true)
                                    .componentPath("/src/views/pull_online/list.vue")
                                    .requiredPermission(new MenuPermission.Builder()
                                            .role(RoleConstants.ROLE.ADMIN)
                                            .permission(GROUP.RECYCLE_BIN, OPERATE.READ)
                                    )
